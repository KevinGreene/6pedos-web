...
if((function (){var G__19760 = v;
if(G__19760){
var bit__13500__auto__ = (G__19760.cljs$lang$protocol_mask$partition1$ & (4096));
if((bit__13500__auto__) || (G__19760.cljs$core$INamed$)){
return true;
} else {
return false;
}
...
var args = cljs.core.seq(arglist__19762);
...
var or__12826__auto__ = reagent.impl.template.attr_aliases.call(null,n);
...
var G__19764 = o;
(G__19764[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__19765){
var vec__19767 = p__19765;
var id = cljs.core.nth.call(null,vec__19767,(0),null);
var class$ = cljs.core.nth.call(null,vec__19767,(1),null);
var pid = (props["id"]);
...
var pname_19768 = reagent.impl.template.cached_prop_name.call(null,k);
(o[pname_19768] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__12814__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__19771 = jsprops;
(G__19771["defaultValue"] = value);

(G__19771["onChange"] = ((function (G__19771,v,value,on_change){
return (function (p1__19769_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__19769_SHARP_);
});})(G__19771,v,value,on_change))
);
...
var vec__19773 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__19773,(0),null);
var id = cljs.core.nth.call(null,vec__19773,(1),null);
var class$ = cljs.core.nth.call(null,vec__19773,(2),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,(cljs.core.truth_((function (){var or__12826__auto__ = id;
if(cljs.core.truth_(or__12826__auto__)){
return or__12826__auto__;
} else {
...
var jsprops = {"argv": v};
var key_19778 = (function (){var temp__4128__auto__ = (function (){var G__19776 = cljs.core.meta.call(null,v);
var G__19776__$1 = (((G__19776 == null))?null:reagent.impl.template.get_key.call(null,G__19776));
return G__19776__$1;
})();
if((temp__4128__auto__ == null)){
...
var G__19777_19779 = key_19778;
var G__19777_19780__$1 = (((G__19777_19779 == null))?null:(jsprops["key"] = G__19777_19779));
...
var vec__19784 = reagent.impl.template.cached_parse.call(null,tag);
var comp = cljs.core.nth.call(null,vec__19784,(0),null);
var id_class = cljs.core.nth.call(null,vec__19784,(1),null);
...
var p = (function (){var temp__4128__auto__ = (function (){var G__19785 = cljs.core.meta.call(null,argv);
var G__19785__$1 = (((G__19785 == null))?null:reagent.impl.template.get_key.call(null,G__19785));
return G__19785__$1;
})();
if((temp__4128__auto__ == null)){
return jsprops;
...
var G__19786 = (((jsprops == null))?{}:jsprops);
(G__19786["key"] = key);
...
var n__13713__auto___19787 = a.length;
var i_19788 = (0);
while(true){
if((i_19788 < n__13713__auto___19787)){
(a[i_19788] = reagent.impl.template.as_element.call(null,(a[i_19788])));

var G__19789 = (i_19788 + (1));
i_19788 = G__19789;
continue;
} else {
}
